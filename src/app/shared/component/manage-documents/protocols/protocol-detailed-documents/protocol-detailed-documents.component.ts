...
@Component({
  selector: 'app-protocol-detailed-documents',
  templateUrl: './protocol-detailed-documents.component.html',
  styleUrl: './protocol-detailed-documents.component.scss'
})
export class ProtocolDetailedDocumentsComponent {
