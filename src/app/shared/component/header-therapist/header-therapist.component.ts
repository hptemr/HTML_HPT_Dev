...
@Component({
  selector: 'app-header-therapist',
  templateUrl: './header-therapist.component.html',
  styleUrls: ['./header-therapist.component.scss']
})
...
export class TherapistHeaderComponent {
  ...
  constructor(public navService: TherapistNavservicesService,  private authService: AuthService,) {
