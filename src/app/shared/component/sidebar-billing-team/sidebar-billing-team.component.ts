...
@Component({
  selector: 'app-sidebar-billing-team',
  templateUrl: './sidebar-billing-team.component.html',
  styleUrls: ['./sidebar-billing-team.component.scss']
})
export class SidebarBillingTeamComponent {
  ...
  constructor(public navService: BillingTeamNavservicesService, public layout: LayoutService) { }
