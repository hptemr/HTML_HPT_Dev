...
const submitObjectiveExercise = async (req, res) => {
  try {
    ...
    console.log(type,'----',exerciseType,'aquatic_exercise>>>>',objective_exercise_data.aquatic_exercise)
    console.log(type,'----',exerciseType,'land_exercise>>>>',objective_exercise_data.land_exercise)
    let message = '';
